        ...
        <button class="navbar-toggler" type="button"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto list-group">
                    ...
                    <li class="list-group-item"><a href="/#section-welcome">Welcome</a></li> |
                    <li class="list-group-item"><a href="/#section-menu">Menu</a></li> |
                    <li class="list-group-item"><a href="/#section-views">Views</a></li> |
                    <li class="list-group-item"><a href="/#section-functions">Functions</a></li> |
                    <li class="list-group-item"><a href="/#section-about">About us</a></li>
